...
Sigmoid-curved filled ribbons and lines for rank comparison charts in ggplot2. Two geoms: `geom_bump_ribbon()` for filled areas and `geom_bump_line()` for stroked paths — both using the same logistic sigmoid interpolation.
...
```{r gdp, echo = FALSE, fig.width = 7, fig.height = 10, dpi = 200}
library(ggplot2)
library(ggbumpribbon)
library(ggflags)
library(countrycode)
